...
namespace ComicsCollectionUnitTests
{
    using ComicsCollection;
    ...
    public class ComicAnalyzerTests
    {
        ...
        public void ComicaAnalyzer_Should_Handle_Weird_Review_Scores()
        {
            var testReviews = new[]
            {
            new Review() {Issue=1, Critic=Critics.MuddyCritic, Score=-12.1243134},
            new Review() {Issue=1, Critic=Critics.RottenTornadoes, Score=1246894174819.1243141212490},
            ...
            var expectedResults = new[]
                {
        "MuddyCritic rated #1 ‘Issue 1’ -12.1243134",
        "RottenTornadoes rated #1 ‘Issue 1’ 1246894174819.1243141212490",
